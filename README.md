...
- [ ] Fix prompt - the emoji doesn't render quite right, it is shifted right a bit onto the parenthasis). I do intend to fix this, but it is a low priority. I may just pick a different prompt character that renders better instead - Update: Planning on using a custom prompt, however, this bug is blocked on [this PR](https://github.com/GamestonkTerminal/GamestonkTerminal/pull/1249).
